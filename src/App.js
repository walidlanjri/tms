    ...
    <Router>
      ...
      <div className="app">
        ...
        <Switch>
          ...
          <PrivateRoute path={
            ["/accueil", "/produits", ,"/produit/:id","/modifierProduit/:id","/livreurs","/livreur/:id", "/clients","/client/:id","/modifierClient/:id", "/details", "/profile","/ajoutProduit","/ajoutLivreur","/ajoutClient"]
          } comp={<Body/>}>
            <NavBar key="Logged" />
            <Body/>
          </PrivateRoute>
